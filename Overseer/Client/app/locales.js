angular.module("overseer").config(["$translateProvider", function($translateProvider) {
    ...
    $translateProvider.translations("en", {                 
        ...
        authenticationLifetimeTitle: "Specifies how long the user will remain logged into the application before needing to re-authenticate. Leave blank to remain logged in indefinitely.",
        authenticationLifetime: "Login Session Duration",
        days: "Days",
