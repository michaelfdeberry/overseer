...
import { BambuLabMachine, Machine } from '../../models/machine.model';

@Component({
  selector: 'app-bambu-machine',
  templateUrl: './bambu-lab-machine.component.html',
  imports: [ReactiveFormsModule, I18NextPipe],
})
export class BambuLabMachineComponent {
  private destroy = inject(DestroyRef);

  webCamOrientations = webCamOrientations;
  machine?: BambuLabMachine;
  ...
  build(form?: FormGroup<BambuMachineForm>, machine?: Machine) {
    ...
    this.form = form;
    this.machine = machine as BambuLabMachine | undefined;
